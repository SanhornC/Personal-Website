    ...
    return (
        ...
        <Container>
            ...
            <Nav className="me-auto">
                ...
                <Nav.Link href="#research_experiences" className={activeLink === 'experiences' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('experiences')}>Research Experiences</Nav.Link>
